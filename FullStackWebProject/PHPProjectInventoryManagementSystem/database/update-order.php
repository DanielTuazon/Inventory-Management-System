<?php
    ...
    try {
        ...
        foreach($purchase_orders as $po){
            ...
            // We don't save the date if it's zero received
            if($delivered > 0){
                ...
                $updated_qty_receieved = $cur_qty_received + $delivered;
                $qty_remaining = $qty_ordered - $updated_qty_receieved; 
                ...
                $stmt->execute([$updated_qty_receieved, $status, $qty_remaining, $row_id]);
        ...
        $response = [
        'success' => false,
        'message' => "Error processing your requests"
        ];
